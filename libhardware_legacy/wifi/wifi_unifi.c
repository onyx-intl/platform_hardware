...
static const char DRIVER_MODULE_NAME[]  = "unifi_sdio";
static const char DRIVER_MODULE_TAG[]   = "unifi_sdio ";
static const char DRIVER_MODULE_PATH[]  = "/system/lib/modules/unifi_sdio.ko";
